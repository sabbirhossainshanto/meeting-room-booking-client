...
const Footer = () => {
  return (
    <div className="bg-[#f3f3f3]  flex flex-col justify-between">
      <div className="grid grid-cols-1 md:grid-cols-2  px-10 py-10 justify-items-center container">
      ...
      <div className="bg-[#2b2d42] ">
        <div className="flex flex-col gap-4 sm:flex-row items-center justify-between py-4  container">
          <Link to="/">
